...
// import { getAnalytics } from "firebase/analytics"; // Uncomment if using analytics in native build
...
// const analytics = getAnalytics(app); // Uncomment if using analytics in native build