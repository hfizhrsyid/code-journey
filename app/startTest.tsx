...
const Test = () => {
    ...
    const buildAdaptivePretest = async () => {
        ...
        const filteredTopics = selectedTopic
            ? sortedTopics.filter((t: any) => (t.name || "").toLowerCase() === selectedTopic.toLowerCase())
            : sortedTopics;
    ...
    return (
        <View style={styles.container}>
            ...
            {selectedTopic ? (
                <Text style={{ color: "#dce6f7", marginBottom: 12, fontWeight: "600" }}>
                    Materi dipilih: {selectedTopic}
                </Text>
            ) : null}
