    ...
    <ScrollView style={styles.container}>
      ...
      <View style={styles.card}>
        <View style={{ flexDirection: "row", justifyContent: "space-between" }}>
          ...
          <View>
            ...
            <Text style={styles.smallText}>
              Skor {stats.correctAnswers} / {stats.totalQuestions}
            </Text>
        ...
        <View style={styles.buttonContainer}>
          <TouchableOpacity style={styles.outlineButton} onPress={() => router.push("/testResult")}>
            <Text style={styles.outlineText}>Hasil Saya</Text>
          </TouchableOpacity>

          <TouchableOpacity style={styles.outlineButton} onPress={handleStartLearning} disabled={unlocking}>
