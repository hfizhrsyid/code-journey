    ...
    <SafeAreaView style={styles.container}>
      ...
      <KeyboardAvoidingView behavior={Platform.OS === "ios" ? "padding" : undefined} keyboardVerticalOffset={8}>
        <View style={styles.inputBar}>
          <TextInput style={styles.input} placeholder="Tanya seputar coding atau materi..." placeholderTextColor="#9fb3d9" value={input} onChangeText={setInput} editable={!sending} multiline />
